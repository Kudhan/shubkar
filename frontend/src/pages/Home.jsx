...
import { Search, Calendar, Star, ArrowRight, CheckCircle, Heart, Users, Mail, Phone } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white font-primary">
            ...
            <footer className="bg-gray-900 text-gray-300 py-12 border-t border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-5 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-gray-300">
                            <li>
                                <a href="mailto:kudhanshaik04@gmail.com" className="flex items-center hover:text-brand-primary transition-colors">
                                    <Mail size={16} className="mr-2 flex-shrink-0" />
                                    <span className="truncate" title="kudhanshaik04@gmail.com">kudhanshaik04@gmail.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="tel:+916304400979" className="flex items-center hover:text-brand-primary transition-colors">
                                    <Phone size={16} className="mr-2 flex-shrink-0" />
                                    <span>+91 6304400979</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-gray-800 text-center text-sm text-gray-500">
                    &copy; 2026 Shubakar Inc. All rights reserved.
                </div>
            </footer>
        </div>
    );
